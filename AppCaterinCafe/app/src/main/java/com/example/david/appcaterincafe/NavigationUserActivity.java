...
public class NavigationUserActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.buy_now:
                ...
                break;
            case R.id.logout:
                startActivity(new Intent(NavigationUserActivity.this, LoginActivity.class));
                break;
